...
Each individual `*.story.js` file could alternatively be customised or written directly in React. This is how the [net-prototype](./stories/net-prototype) stories are written. Stories can also be added to the section normally using `stories.add()` and `storiesOf()`.
